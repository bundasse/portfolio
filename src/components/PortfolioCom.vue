<template lang="">
    <div id="portfolio">
        ...
        <section>
            <router-link to="/portfolio" v-for="e in catelist" :key="e" @click="this.$store.state.catename = e.title;" :style="`background-image: url('${e.img}'); background-size: cover; background-repeat: no-repeat; background-position: center`">
                <article><h4>{{e.title}}</h4><p v-html="e.desc"></p></article>
            </router-link>
        </section>
    </div>
</template>
            ...
            catelist:[
                {
                    ...
                    img:"https://i.ibb.co/FJG9bqY/bg-clone.png"
                },
                {
                    title:"웹앱",
                    ...
                    img:"https://i.ibb.co/wgm05cF/bg-webapp.png"
                },             
                {
                    title:"홈페이지",
